...
namespace Step2
{
    public class FindNearest : MonoBehaviour
    {
        ...
        public void Update_Config()
        {
            ...
            int amount_units; int amount_threads = 0; //int amount_frames;
            ...
            //JobsUtility.JobWorkerCount = amount_threads; // this is single thread therefore zero which is one thread only
