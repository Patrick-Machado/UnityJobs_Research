...
namespace Tayx.Graphy.Fps
{
    public class G_FpsText : MonoBehaviour
    {
        ...
        [SerializeField] public     Text            m_avgFpsText        = null;
        [SerializeField] public     Text            m_minFpsText        = null;
        [SerializeField] public     Text            m_maxFpsText        = null;
        ...
        public struct fpsData { public string m_avgFpsText; public string m_minFpsText; public string m_maxFpsText; }
        public fpsData collectFPS_data()
        {
            //int _aFPS; int _maxFPS; int _minFps;

            //int.TryParse(m_avgFpsText.text, out _aFPS);
            //int.TryParse(m_maxFpsText.text, out _maxFPS);
            ///int.TryParse(m_minFpsText.text, out _minFps);
            fpsData data = new fpsData { 
                m_avgFpsText = m_avgFpsText.text,
                m_maxFpsText = m_maxFpsText.text,
                m_minFpsText = m_minFpsText.text
            };
